  ...
  - block: markdown
    ...
    content:
      ...
      text: |
        ...
        <p><strong>Prof. Tsai-Wei Wu</strong> has been selected as a <strong>Yushan Young Fellow (玉山青年學者)</strong> — 2026 Ministry of Education's Yushan Young Scholar Program. 🎉</p>
        </div>
        </div>
        <div class="award-card">
        <div class="award-body">
